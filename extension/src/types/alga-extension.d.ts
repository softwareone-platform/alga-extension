...
declare module "alga:extension/storage" {
  ...
  export function listEntries(namespace: string, cursor?: string | null): StorageEntry[];
}
...
declare module "alga:extension/ui-proxy" {
  ...
  export function callRoute(route: string, payload?: Uint8Array | null): Uint8Array; // throws ProxyError
}
